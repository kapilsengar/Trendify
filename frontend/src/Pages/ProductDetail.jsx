...
function ProductDetail() {
 ...
 <button
  className="text-[16px] active:bg-slate-500 cursor-pointer bg-[#495b61c9] py-[10px] px-[20px] rounded-2xl mt-[10px] border-[1px] border-[#80808049] text-white shadow-md shadow-black flex items-center justify-center"
  onClick={() => {
  if (!size) {
...
>
  {loading ? <Loading /> : "Add to Cart"}
        ...
        <div className='w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col  overflow-x-hidden'>
            ...
            <div className='flex px-[20px] mt-[90px] lg:ml-[80px] ml-[0px]  lg:mt-[0px] sm:flex-row  gap-3 
                px-[20px] mt-[120px] '>
     ...
     <div className='w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px]'>
      ...
      Upgrade your wardrobe with this stylish slim-fit cotton shirt, available now on Trendify. Crafted from breathable, high-quality fabric, it offers all-day comfort and effortless style. Easy to maintain and perfect for any setting, this shirt is a must-have essential for those who value both fashion and function.</p>
     </div>
